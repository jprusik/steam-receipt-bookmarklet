if (['https://store.steampowered.com/account/','https://store.steampowered.com/account'].indexOf(location.href) > -1) {
    ...
    (function() {
        ...
        jQuery('head').append('<style type="text/css" id="steam_gauge_styles">#steam_gauge_wrapper{width:100%;margin:1em 0px;padding: 1em;background-color:slategray;border-corner:5px}#steam_gauge_receipt{width:50%;float:left;}#steam_gauge_receipt_table{width:50%;float:right;border-width: 0px !important;border-collapse: collapse !important;}.sg_col1{text-align:right;}.sg_col2{text-align:left;padding-left: 0.5em;}.youraccount_tabs{clear:both;}</style>');
    })();
